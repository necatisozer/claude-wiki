...
```
curl -fsSL https://raw.githubusercontent.com/necatisozer/claude-wiki/v0.1.3/install.sh | bash -s -- owner/repo
```
...
```
curl -fsSLO https://raw.githubusercontent.com/necatisozer/claude-wiki/v0.1.3/install.sh
bash install.sh
```
