...
Structure:
- FIRST LINE: a single-sentence summary, ≤ 120 characters, no heading, no leading "-". This becomes the entry's one-line description.
...
Rules:
- The FIRST LINE must be YOUR OWN ≤120-char summary sentence — NEVER a quote, a tool action ("Let me…"), a heading, a question, or text copied from the transcript.
