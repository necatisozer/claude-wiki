...
- Select AT MOST {{MAX_SELECTED}} pages. If nothing existing is relevant (e.g. the entries are all brand-new topics), output the two markers with no paths between them.
